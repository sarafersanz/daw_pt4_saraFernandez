...
public class Pedidos_todos {
	...
	public static void cargarDatos() throws ServletException
	{
		...
		try
		{
			...
			String sqlStr = "SELECT p.id_pedido, p.fecha_pedido, p.total_pedido, IF(p.estado_pedido = '0', 'PENDIENTE', 'ENVIADO') as estado_pedido, u.nombre_usuario FROM pedidos as p, usuarios as u WHERE u.id_usuario = p.id_usuarioFK ORDER BY p.id_pedido DESC";
